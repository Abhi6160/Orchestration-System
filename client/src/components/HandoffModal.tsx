      ...
      <div className="bg-surface-container-lowest border border-outline-variant rounded-2xl w-full max-w-3xl max-h-[90vh] flex flex-col shadow-xl overflow-hidden">
            ...
            <>
                ...
                <div className="flex items-center justify-between gap-4 flex-wrap pb-3 border-b border-outline-variant/60">
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <span className="font-semibold text-secondary text-xs">Claude 3.5 Sonnet</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <span className="font-semibold text-blue-700 text-xs">Gemini 1.5 Pro</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-1.5">
                <label className="flex items-center gap-1.5 font-semibold text-primary">
                  ...
                  <span>5. Directive Instructions for Gemini</span>
                </label>
                <textarea
        ...
        <div className="px-6 py-4 border-t border-outline-variant bg-surface flex items-center justify-between gap-3">
          <div className="text-[11px] text-on-surface-variant">
            Target: <strong className="text-primary font-medium">Gemini 1.5 Pro (2M Context)</strong>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white px-4 py-2 rounded-lg text-xs font-semibold flex items-center gap-2 shadow-xs transition-colors cursor-pointer disabled:opacity-50"
            >
              {isSubmitting ? (
                <>
                ...
                <>
                  <Sparkles className="w-3.5 h-3.5" />
                  <span>Confirm & Continue in Gemini</span>
                </>
              )}
            </button>
          </div>
