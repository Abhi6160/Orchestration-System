...
interface GeminiTransitionProps {
  message: Message;
}

export const GeminiTransition: React.FC<GeminiTransitionProps> = ({ message }) => {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-on-surface-variant flex items-center gap-1.5 mt-0.5">
                <span className="font-semibold text-secondary">Claude 3.5 Sonnet</span>
                <span>→</span>
                <span className="font-semibold text-blue-700">Gemini 1.5 Pro</span>
        ...
        {isExpanded && (
          <div className="mt-4 pt-4 border-t border-outline-variant/60 space-y-3 text-xs animate-in fade-in duration-200">
            ...
            <div className="flex items-center justify-between text-[10px] text-on-surface-variant font-mono pt-1">
              <span>Ingestion Buffer: 2,000,000 token ceiling</span>
              <span className="text-blue-700 font-semibold">Gemini Active Session</span>
            </div>
          </div>
        )}
      </div>
