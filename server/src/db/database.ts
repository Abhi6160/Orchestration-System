...
export interface ConversationRecord {
  ...
  title: string;
  project_tag: string;
  current_provider: 'claude' | 'gemini';
...
export const dbService = {
  ...
  createConversation(data: Partial<ConversationRecord> & { title: string; project_tag?: string; current_provider?: 'claude' | 'gemini' }): ConversationRecord {
  ...
  addMessage(message: Partial<MessageRecord> & { conversation_id: string; role: 'user' | 'assistant' | 'system'; content: string; provider: 'claude' | 'gemini' | 'user' | 'system' }): MessageRecord {
