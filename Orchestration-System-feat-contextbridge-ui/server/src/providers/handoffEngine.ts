import { ChatMessage, HandoffPayload, ProviderId } from './types.js';
...
export class HandoffEngine {
  ...
  static generateHandoff(
    ...
    const instructionsForNextAi = `You are taking over this conversation from ${getAdapter(fromProvider).displayName}. Acknowledge the handoff smoothly in 1 concise sentence, confirm you have digested the Project Apollo timeline & context, and directly answer the user's pending question regarding high-scrutiny security audit endpoints with actionable technical depth.`;
